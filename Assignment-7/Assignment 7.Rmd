...
Contributions: Jason and Ariel worked on separate machines, where Ariel started the first half of the assignment (General QC and PCA), and Jason worked on the rest of the assignment (imputation to PGS accuracy). Online collaboration was done via downloading the Ariel's QC analysis files from BCGSC server onto Jason's machine. Both Jason and Ariel reviewed the comprehension questions and plots together.
